...
public class AuthenticationService {
     ...
     */
    public void setNewPassword(String userId, String oldPassword, String newPassword, String confirmNewPassword) {
        ...
        accountRepository.save(account);  // Saving the account without needing to return it
    }
}